...
function Navbar() {
    return (
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    <a class="nav-item nav-link active" href="/">Home/AllJournals <span class="sr-only">(current)</span></a>
                    <a class="nav-item nav-link" href="/AllEntries">AllEntries</a>
                    <a class="nav-item nav-link" href="/CreateEntry">CreateEntry</a>
                    <a class="nav-item nav-link" href="/Quotes">My Quotes</a>
                    <a class="nav-item nav-link" href="/About">About</a>
                    <a class="nav-item nav-link" href="/EntryPage">EntryPage</a>
                </div>
            </div>
        </nav>
        ...
        //         <Link to="/" className={window.location.pathname === "/home" ? "nav-link active" : "nav-link"}>jot</Link>
        //     </span>
        ...
        //                 <Link to="/" className={window.location.pathname === "/home" ? "nav-link active" : "nav-link"}>Home/AllJournals</Link>
        //             </li>
        //             <li className="nav-item" data-toggle="collapse" data-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
